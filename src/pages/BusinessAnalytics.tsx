...
import { Leaf, LogOut, ArrowLeft, TrendingUp, Package, DollarSign, Users } from "lucide-react";
      ...
      <main className="container mx-auto px-4 py-8">
        ...
        <div className="flex items-center gap-4 mb-8">
          ...
          <div>
            ...
            <p className="text-muted-foreground">Insights and recommendations for your surplus inventory</p>
          </div>
        </div>
